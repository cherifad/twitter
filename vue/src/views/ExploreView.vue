...
<template>
  <div class="relative">
    ...
    <div class="mt-5" v-if="route.name != 'Search'">
      <SingleTrend title="#Macron13h" theme="Seulement sur Twitter · Tendances" :ranking="1" :numberOfTweets="100000" />
      <SingleTrend title="Squeezie" theme="Divertissement · Tendances" :ranking="1" :numberOfTweets="3469" />
      <SingleTrend title="Président de la République" theme="Tendances dans la catégorie Politique" :ranking="1"
        :numberOfTweets="19400" />
      <SingleTrend title="Président de la République" theme="Tendances" :ranking="1" :numberOfTweets="19400" />
      <SingleTrend title="Pemamanuel Pacron" theme="Tendances dans la catégorie Politique" :ranking="2" />
      <SingleTrend title="Anne Sophie Lapix" theme="Tendances dans la catégorie France" :ranking="3" />
    </div>
    <div v-else>
      <SingleTweet v-if="state.tweets" v-for="tweet in state.tweets" :tweet-author="tweet.tweet.tweet_user.name"
        :tweet-media="null" :tweet-media-count="0" :tweet-author-avatar="tweet.tweet.tweet_user.profile_picture_url"
        :tweet-author-username="tweet.tweet.tweet_user.username" :tweet-author-verified="tweet.tweet.tweet_user.premium"
        :tweet-content="tweet.tweet.content" :tweet-date="tweet.tweet.created_at"
        :tweet-likes="tweet.tweet.tweet_likes_aggregate.aggregate.count"
        :tweet-retweets="tweet.tweet.tweet_retweets_aggregate.aggregate.count" :tweet-replies="2547"
        :tweet-bookmarked="false" :tweet-liked="true" :tweet-retweeted="false" :tweet-replied="false" tweet-media="258"
        :tweet-views="25874123" :tweet-id="tweet.tweet.id" :tweet-thread="false" />
    </div>
